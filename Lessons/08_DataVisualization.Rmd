...
O3plot2 <- ggplot(EPAair) +
  geom_point(aes(x = Date, y = Ozone), color = "blue") #correccted it; earlier the closing bracket was after "blue" - Monisha
print(O3plot2)
...
O3plot <- ggplot(PeterPaul.chem.nutrients) +
  geom_point(aes(x = daynum, y = temperature_C))
print(O3plot)

PP.temo <-
  ggplot(subset(PeterPaul.chem.nutrients) # incomplete Kateri's code :(
...
# look at the caveats link to see why we didnt explore bar plots today - Monisha
```
