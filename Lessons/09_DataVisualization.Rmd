...
# make use of theb help function to look at the various themes - monisha
```
...
#AQI indexes - google it - monisha - compare relative - take concentrations and convert to common scales that is good, moderate etc. 
```
...
NvsP2 <-
  ...
  labs(x = expression(paste("TP (", mu, "g/L)")),
       ...
       color = "Depth (m)", shape = "") + # change your legend labels here - edited and working now - monisha
...
Nutrientplot <-
  ...
  geom_boxplot() + labs(x = expression(paste("TP (", mu, "g/L")),
       y = expression(paste("TN (", mu, "g/L")))
# place your additional edits here - edited - monisha - do it later
